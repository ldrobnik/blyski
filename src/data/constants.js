...
const text1 = (
  <React.Fragment>
    <div title="Pierwszy tekst">i</div>
...
const text3 = (
  <React.Fragment>
    <div title="Trzeci tekst">iii</div>
...
const text4 = (
  <React.Fragment>
    <div title="Czwarty tekst">iv</div>
...
export const WEBSITE_TEXT = {
  ...
  issueList: {
    magazineName: "błyski",
    translator: (
      <React.Fragment>w&nbsp;przekładzie Łukasza Drobnika</React.Fragment>
    ),
    bio: "biogram",
  ...
  about: {
    ...
    content: (
      <React.Fragment>
        <p>
          Flash fiction to bardzo krótkie opowiadania – takie do przeczytania
          w&nbsp;parę minut. W&nbsp;odróżnieniu od prozy poetyckiej zawsze mają
          fabułę.
        </p>
        <p>
          Z&nbsp;kolei{" "}
          ...
          to nieregularnik, który stawia sobie za cel przybliżenie polskim
          czytelnikom tej popularnej w&nbsp;świecie anglosaskim formy.
        </p>
        <p>
          Każdy numer{" "}
          <HoverableLink>
          ...
          jest poświęcony jednemu autorowi: zawiera pięć jego tekstów plus
          biogram – i&nbsp;tyle.
        </p>
        <p>
          Bohaterką{" "}
    ...
    contact: (
      <React.Fragment>
        <strong>Kontakt z&nbsp;redakcją:</strong> blyski.pismo [at] gmail [dot]
        com.
      </React.Fragment>
    ),
    disclaimer: (
      <React.Fragment>
        Idea <strong>błysków</strong> jest taka, by ukazywały się w nich
        przekłady tekstów napisanych po angielsku, dlatego niestety nie
        rozpatruję propozycji wydawniczych, choć do samego pisania flash fiction
        gorąco zachęcam! Obecnie <strong>błyski</strong> nie szukają też do
        współpracy tłumaczy.
      </React.Fragment>
    ),
    credits: (
      <React.Fragment>
        red. nacz. –&nbsp;ja, dobór tekstów –&nbsp;ja, przekłady –&nbsp;ja,
        projekt strony –&nbsp;ja*
      </React.Fragment>
    ),
    footnote: (
  ...
  pubTerms: {
    title: "błyski",
    subtitle: (
      <React.Fragment>flash fiction in Polish translation</React.Fragment>
    ),
    content: (
      <React.Fragment>
        <p>
          ...
          (Polish for <em>flashes</em>) is a journal publishing solicited flash
          fiction in Polish translation. It is run by{" "}
          <HoverableLink>
            <a
              href="https://drobnik.co"
              target="_blank"
              ...
              className={"underlined"}
            >
              <strong>Łukasz Drobnik</strong>
            </a>
          </HoverableLink>
          .
        </p>
        <p>
          The journal is a minimalist affair—each issue is made of five flashes
          by one author and their bio. That’s it.
        </p>
        <p>
          The latest issue is dedicated to{" "}
          <HoverableLink>
            <a
              href="https://blyski.org/2"
              target="_blank"
              rel="noopener noreferrer"
              className={"underlined"}
            >
    ...
    deal: (
      <React.Fragment>
        <p>
          We offer <strong>50&nbsp;USD</strong>, payable before the issue goes
          live, via PayPal or other agreed service.
        </p>
        <p>
          We ask for <strong>one-time Polish translation rights</strong> to
          publish your stories on the website and, possibly, in a future
          anthology.
        </p>
      </React.Fragment>
    ),
    contact: (
      <React.Fragment>
        <p>
          <strong>Contact:</strong> blyski.pismo [at] gmail [dot] com.
        </p>
      </React.Fragment>
    ),
  },
...
export const ISSUES = [
  ...
  },
  {
    ...
    texts: [
      ...
      {
        title: "Lunarna miłość",
        slug: "lunarna-milosc",
      },
      {
        title: "W całej swej wspaniałości",
        slug: "w-calej-swej-wspanialosci",
      },
      {
        title: "Księżyce Jowisza",
        slug: "ksiezyce-jowisza",
      },
      {
        title: "Linienie",
        slug: "linienie",
    ...
    alt: "Niebiała kobieta z czarnymi włosami do ramion i w kolczykach, wpatrzona z półuśmiechem w obiektyw",
  },
];
...
export const AUTHOR_LINKS = [
    ...
    works: [
      {
        ...
        links: [
          ...
          {
            title:
              "„After the Wal-Mart Closes in Your Hometown” [Pithead Chapel]",
      ...
      },
      {
        ...
        links: [
          ...
          {
            title:
              "„While the Men Go Hunt the Shark, Mrs. Brody Meets Her Lover” [Hobart]",
      ...
      },
      {
        ...
        links: [
          {
            title:
              "„Instructions for Fucking Your Postpartum Wife” [Lost Balloon]",
    ...
    works: [
      {
        ...
        links: [
          {
            title: "„Ghosts of You” [Okay Donkey Press]",
      ...
      },
      {
        ...
        links: [
          {
            title:
              "„Your Girlfriend as a Weapon of Mass Destruction” [100 word story]",
            url: "http://100wordstory.org/your-girlfriend-as-a-weapon-of-mass-destruction/",
          },
          {
            title:
              "„Your Girlfriend as a Radium Watch Face” [The Citron Review]",
  ...
  },
  {
    links: [
      {
        icon: websiteIcon,
        url: "https://taraisabelzambrano.wixsite.com/website",
      },
      {
        icon: twitterIcon,
        url: "https://twitter.com/tara_zambrano",
      },
      {
        icon: instagramIcon,
        url: "https://www.instagram.com/tizambrano/",
      },
    ],
    works: [
      {
        ...
        links: [
          {
            title:
              "„Death, Desire, and Other Destinations” [Okay Donkey Press]",
      ...
      },
      {
        ...
        links: [
          {
            title: "„Alligators” [Barrelhouse]",
            url: "https://www.barrelhousemag.com/onlinelit/tara-isabel-zambrano-alligators",
          },
          {
            title: "„Lunar Love” [Waxwing Literary Journal]",
            url: "https://waxwingmag.org/items/issue20/37_Zambrano-Lunar-Love.php",
          },
          {
            title: "„In Its Entire Splendor” [Vestal Review]",
            url: "https://vestalreview.net/in-its-entire-splendor-by-tara-isabel-zambrano/",
          },
          {
            title: "„The Moons of Jupiter” [The Coil]",
            url: "https://medium.com/the-coil/the-moons-of-jupiter-an-excerpt-from-tara-isabel-zambranos-death-desire-other-destinations-461552de0973",
          },
        ],
        footnote:
      ...
      },
      {
        ...
        links: [
          {
            title: "„New Old” [The Southampton Review]",
            url: "https://www.thesouthamptonreview.com/winterspring-2019-1/2018/10/23/new-old",
          },
          {
            title: "„Mumtaz in Burhanpur” [Bat City Review]",
            url: "http://www.batcityreview.org/tara-isabel-zambrano",
          },
          {
            title: "„We’re Waiting to Hear Our Names” [Volume 1 Brooklyn]",
            url: "https://vol1brooklyn.com/2020/08/18/were-waiting-to-hear-our-names-an-excerpt-from-tara-isabel-zambranos-death-desire-and-other-destinations/",
          },
          {
            title: "„Whatever Remains” [Tin House]",
            url: "https://tinhouse.com/whatever-remains/",
          },
          {
            title: "„A Thousand Eyes” [PANK Magazine]",
            url: "https://pankmagazine.com/piece/a-thousand-eyes",
          },
        ],
      },
      {
        heading: "Teksty spoza zbioru",
        links: [
          {
            title: "„Uncouple” [The Arkansas International]",
            url: "https://www.arkint.org/tara-isabel-zambrano",
          },
          {
            title:
              "„Mouth, Unhinged”, „It Isn’t Halloween until You Marry a Ghost” [Middle House Review]",
            url: "https://www.middlehousereview.com/zambrano-halloween",
          },
          {
            title: "„A Castle in The Clouds” [superstition review]",
            url: "https://superstitionreview.asu.edu/issue21/fiction/taraisabelzambrano",
          },
          {
            title: "„A Small Crack Between a Bed and a Wall” [Devil’s Lake]",
            url: "https://dept.english.wisc.edu/devilslake/issues/2016_spring/zambrano.html",
          },
          {
            title: "„Susie’s Boyfriends” [Columbia Journal]",
            url: "http://columbiajournal.org/susies-boyfriends-by-tara-isabel-zambrano/",
          },
          {
            title: "„Jump-off Point” [FlashFlood]",
            url: "http://flashfloodjournal.blogspot.com/2020/06/jump-off-point-by-tara-isabel-zambrano.html",
          },
          {
            title: "„The Vaulting Bodies Are Birds” [Flash Frontier]",
            url: "https://flashfrontier.com/september-2017-trees/#birds",
          },
          {
            title: "„Six Places I Am Disintegrated” [Rhythm & Bones]",
            url: "https://www.rhythmnbone.com/single-post/2019/04/21/six-places-i-am-disintegrated",
          },
        ],
      },
    ],
