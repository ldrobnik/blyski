...
export const WEBSITE_TEXT = {
    ...
    pubTerms: {
        ...
        content: <React.Fragment>
            ...
            <p>The newest issue is dedicated to <HoverableLink><a href="https://blyski.org/2" target="_blank" rel="noopener noreferrer" className={'underlined'}><strong>Cathy Ulrich</strong></a></HoverableLink>.</p>
        </React.Fragment>,
        deal: <React.Fragment>
